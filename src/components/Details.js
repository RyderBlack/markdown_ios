  ...
  render() {
    return (
        ...
        {this.props.details.map((startup) => {
          ...
          return (
        <div key={startup.props.id} className="col-md-3">
            <div className={ startup.props.hiring ? "card text-white bg-default mb-3 bg-success" : "card text-white bg-default mb-3 bg-danger"} style={{"maxWidth": "18rem"}}>
